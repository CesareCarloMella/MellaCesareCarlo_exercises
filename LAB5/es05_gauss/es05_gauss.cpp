...
//**********************************************************************
	...
	//lettura dei parametri
        ...
        while(segnale==1) {
                ...
                lanci=0;
                for(int i=0; i<100; i++) {
                        incr=T_Gauss(rnd, delta);     	//genera una proposta
...
//La delta e' ok. Procedo con la simulazione
        ofstream printR("risultatiGauss/raggi100.out");
      	ofstream printP("risultatiGauss/posizioni100.out");
        for(int i=0; i<N; i++) {
                prog[i]=0.;
                prog2[i]=0.;
        }
       ...
       printR.close();
       printP.close();
       printR.open("risultatiGauss/progressivi100.out");
